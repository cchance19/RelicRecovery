## Welcome!
This GitHub repository contains the team code for the Sparbots that is used to build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK, download/clone the entire project to your local computer.
